...
def test_retrieve_document(md_content: str, html_content: str, faker: Faker, client: APIClient) -> None:
    slug = faker.slug()
...
def test_retrieve_document_with_template_extend(md_content: str, html_content: str, template: str, faker: Faker, client: APIClient) -> None:
